...
<div class="search_box_top">
	<div class="search_box_path"><a href="http://www.youtube.com">YouTube</a> / <a href="http://SERVER/YouSearch/cluster/">YouSearch</a> / <a href="http://SERVER/YouSearch/KEYWORD">KEYWORD</a> / <span style="color:yellow">clusters</span></div>
	<span class="search_box_form"><form action=""><input type="text"><input type="submit" value="Submit"></span>
</div>
...
<div id="search_box">
	<script type="text/javascript">
		...
		$.get("http://SERVER/YouSearch/search/movie",{},
						function(data){
