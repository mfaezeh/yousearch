...
public abstract class Filter implements Serializable, CapabilitiesHandler,
	...
	public static String wekaStaticWrapper(Sourcable filter, String className,
		...
		result
				.append(((Filter) filter).getCapabilities().toSource("result",
						4));
		...
		result.append("  /**\n");
		result
				.append("   * turns the Instance object into an array of Objects\n");
		result.append("   *\n");
		result.append("   * @param inst	the instance to turn into an array\n");
		result
				.append("   * @return		the Object array representing the instance\n");
		result.append("   */\n");
		result
				.append("  protected Object[] instanceToObjects(Instance inst) {\n");
		...
		result.append("  /**\n");
		result
				.append("   * turns the Instances object into an array of Objects\n");
		result.append("   *\n");
		...
		result
				.append("      result[i] = instanceToObjects(data.instance(i));\n");
		result.append("\n");
		result.append("    return result;\n");
		result.append("  }\n");
