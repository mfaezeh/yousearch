...
/**
 <!-- globalinfo-start -->
 * Implementing YouTag distance (or similarity) function.<br/>
 * <br/>
...
public class YouTagDistance
  ...
  public String globalInfo() {
    return 
        "Implementing YouTag distance (or similarity) function.\n\n"
  ...
  public TechnicalInformation getTechnicalInformation() {
    ...
    result.setValue(Field.URL, "http://en.wikipedia.org/wiki/YouTag_distance");
